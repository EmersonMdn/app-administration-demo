...
class PowerBIService {
    constructor() {
        this.clientId = process.env.REACT_APP_POWERBI_CLIENT_ID;
        this.tenantId = process.env.REACT_APP_POWERBI_TENANT_ID;
        this.clientSecret = process.env.REACT_APP_POWERBI_CLIENT_SECRET;
        this.scope = 'https://analysis.windows.net/powerbi/api/.default';
        this.authority = `https://login.microsoftonline.com/${this.tenantId}/oauth2/v2.0/token`;
    }
    ...
    async getAccessToken() {
        try {
            ...
            console.error('Error obteniendo token de Power BI:', error);
